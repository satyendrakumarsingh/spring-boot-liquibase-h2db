...
# Spring Boot2 Liquibase Integration
In this sample application H@ in memory database is used to show simple integration of Liquibase using change log files.
